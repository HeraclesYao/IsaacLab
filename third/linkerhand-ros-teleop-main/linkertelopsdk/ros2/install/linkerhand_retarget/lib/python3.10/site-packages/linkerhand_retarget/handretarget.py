...
class HandRetargetNode(Node):
    def __init__(self):
        ...
        if self.handconfig.baseconfig["system"]["robotname_r"] == "free":
            self.handconfig.baseconfig["system"]["robotname_r"] = "o7"
            self.handconfig.baseconfig["system"]["robotname_l"] = "o7"
            self.handcore = HandCore(self.handconfig)
            self.handconfig.baseconfig["system"]["robotname_r"] = "free"
            self.handconfig.baseconfig["system"]["robotname_l"] = "free"
        else:
            self.handcore = HandCore(self.handconfig)
